          ...
          <div className="px-4 pt-2 pb-4 space-y-1">
            ...
            {isAuthenticated && user ? (
              <div className="pt-4 mt-4 border-t border-gray-100">
                {/* Mobile menu items */}
                {user.role === 'provider' && (
                  <Link href="/dashboard/freelance" passHref>
                    <span className="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-100">
                      <span className="flex items-center">
                        <IconDashboard className="mr-3 h-5 w-5 text-gray-500" />
