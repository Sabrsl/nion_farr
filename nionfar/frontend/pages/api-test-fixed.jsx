...
export default function APITestFixed() {
  return (
    <div>
      ...
      <p>Cette page est le point d'entrée pour tester la connexion entre le frontend et le backend.</p>
      
      {/* Tout le contenu qui utilise des APIs navigateur est enveloppé dans ClientOnly */}
      <ClientOnly>
        <APITestContent />
      </ClientOnly>
    </div>
