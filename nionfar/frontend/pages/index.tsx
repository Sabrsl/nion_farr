                ...
                <div className="relative">
                  ...
                  <div className="relative bg-white dark:bg-gray-900 p-3 sm:p-5 rounded-xl sm:rounded-2xl shadow-lg sm:shadow-2xl overflow-hidden">
                    <img 
                      ...
                      onError={(e) => {
                        (e.target as HTMLImageElement).src = 'https://placehold.co/600x400/6366f1/ffffff?text=NionFar';
                      }}
                    />
...
const categories = [
  { id: 1, name: 'Design graphique', slug: 'design-graphique', count: 250, icon: '🎨', image: '/img/categories/design-graphique.jpg' },
  { id: 2, name: 'Développement web', slug: 'developpement-web', count: 320, icon: '💻', image: '/img/categories/developpement-web.jpg' },
  { id: 3, name: 'Rédaction & traduction', slug: 'redaction', count: 180, icon: '✍️', image: '/img/categories/redaction.jpg' },
  { id: 4, name: 'Marketing digital', slug: 'marketing-digital', count: 210, icon: '📱', image: '/img/categories/marketing-digital.jpg' },
  { id: 5, name: 'Montage vidéo', slug: 'montage-video', count: 150, icon: '🎬', image: '/img/categories/montage-video.jpg' },
  { id: 6, name: 'Voix off', slug: 'voix-off', count: 90, icon: '🎤', image: '/img/categories/voix-off.jpg' },
  { id: 7, name: 'SEO', slug: 'seo', count: 120, icon: '🔍', image: '/img/categories/seo.jpg' },
  { id: 8, name: 'Coaching', slug: 'coaching', count: 80, icon: '🏆', image: '/img/categories/coaching.jpg' },
];
