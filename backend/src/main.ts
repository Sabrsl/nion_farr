...
async function bootstrap() {
  ...
  try {
    ...
    const allowedOrigins = [
      frontendUrl,
      'https://nionfar.vercel.app',
      'https://nionfar-frontend.vercel.app',
      'https://www.nionfar.vercel.app',
    ...
    console.log('Configuration CORS avec les origines suivantes:', allowedOrigins);
    
    // Solution temporaire: autoriser toutes les origines pour résoudre le problème de "Network Error"
    app.enableCors({
      origin: '*', // Temporairement autorise toutes les origines
      methods: ['GET', 'POST', 'PUT', 'DELETE', 'PATCH', 'OPTIONS'],
      allowedHeaders: ['Content-Type', 'Authorization', 'Accept', 'X-Requested-With'],
      credentials: true
    });
    
    // Ajout d'un middleware pour les preflight OPTIONS
