...
let AppController = (() => {
    let _classDecorators = [(0, swagger_1.ApiTags)('App'), (0, common_1.Controller)('api')];
    ...
    var AppController = class {
        ...
        static {
            ...
            _getHello_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Endpoint racine' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Renvoie un message de bienvenue' })];
            _getHealth_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Get)('health'), (0, swagger_1.ApiOperation)({ summary: 'Vérifier l\'état de santé de l\'API' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'L\'API est en bon état de fonctionnement' })];
