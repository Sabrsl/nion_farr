        ...
        handleRequest(err, user, info, context) {
            ...
            if (err || !user) {
                if (info instanceof jsonwebtoken_1.TokenExpiredError) {
                    ...
                    throw new common_1.UnauthorizedException('Token invalide. Veuillez vous reconnecter.');
                }
                else {
                    throw new common_1.UnauthorizedException('Non autorisé. Veuillez vous connecter.');
                }
            }
            return user;
        }
