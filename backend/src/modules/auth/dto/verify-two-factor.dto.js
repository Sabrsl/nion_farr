    ...
    return class VerifyTwoFactorDto {
        static {
            ...
            _userId_decorators = [(0, swagger_1.ApiProperty)({
                ...
                }), (0, class_validator_1.IsUUID)('4', { message: 'L\'ID utilisateur doit être un UUID valide' }), (0, class_validator_1.IsNotEmpty)({ message: 'L\'ID utilisateur est requis' })];
            _twoFactorCode_decorators = [(0, swagger_1.ApiProperty)({
                    example: '123456',
                    description: 'Code de vérification pour l\'authentification à deux facteurs',
                }), (0, class_validator_1.IsString)({ message: 'Le code doit être une chaîne de caractères' }), (0, class_validator_1.IsNotEmpty)({ message: 'Le code est requis' }), (0, class_validator_1.Length)(6, 6, { message: 'Le code doit contenir exactement 6 caractères' }), (0, class_validator_1.Matches)(/^[0-9]+$/, { message: 'Le code doit contenir uniquement des chiffres' })];
