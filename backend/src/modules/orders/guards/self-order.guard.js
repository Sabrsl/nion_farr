...
let SelfOrderGuard = (() => {
    ...
    let _classThis;
    var SelfOrderGuard = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            SelfOrderGuard = _classThis = _classDescriptor.value;
        ...
        async canActivate(context) {
            ...
            if (service.providerId === user.id) {
                throw new common_1.ForbiddenException('Vous ne pouvez pas commander votre propre service');
            }
            return true;
        }
    };
    return SelfOrderGuard = _classThis;
})();
exports.SelfOrderGuard = SelfOrderGuard;
