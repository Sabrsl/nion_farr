...
const services_service_1 = require("./controllers/services.service");
const service_category_entity_1 = require("./entities/service-category.entity");
const service_option_entity_1 = require("./entities/service-option.entity");
let ServicesModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            imports: [typeorm_1.TypeOrmModule.forFeature([service_entity_1.Service, service_category_entity_1.ServiceCategory, service_option_entity_1.ServiceOption])],
