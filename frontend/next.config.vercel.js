...
const nextConfig = {
    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Access-Control-Allow-Origin', value: 'https://nion-farr.vercel.app,https://nionfar-backend.onrender.com' },
  ...
  async rewrites() {
    const apiUrl = 'https://nionfar-backend.onrender.com/api';
...
console.log(`[Next.js Config] URL de l'API configurée: ${nextConfig.env.NEXT_PUBLIC_API_URL}`);
