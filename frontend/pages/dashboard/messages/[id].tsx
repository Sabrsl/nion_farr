...
const ConversationPage: NextPage = () => {
  ...
  useEffect(() => {
    if (id) {
      // Récupérer les données de conversation depuis l'API au lieu des données mock
      // Pour l'instant, utiliser un objet vide en attendant l'implémentation
      setConversation({
        id: id as string,
        participants: [],
        lastMessage: '',
      ...
      // Récupérer les messages depuis l'API au lieu des données mock
      setMessages([]);
    }
  }, [id]);
