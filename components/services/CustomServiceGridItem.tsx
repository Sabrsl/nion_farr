...
interface CustomServiceGridItemProps {
...
export const CustomServiceGridItem: React.FC<CustomServiceGridItemProps> = ({ 
  service,
  className = '' 
}) => {
  const { 
  ...
  return (
    ...
    >
      {/* Image du service avec badge "Populaire" si nécessaire */}
      ...
      <div className="p-4">
            ...
            <div className="flex items-center text-sm text-gray-500 mb-2">
              ...
              {rating > 0 && (
                <div className="flex items-center">
                  <FiStar className="h-3 w-3 text-amber-500 mr-0.5" />
        ...
        <div className="mt-2 pt-2 border-t border-gray-100 flex items-center justify-between">
          <div className="flex items-center text-gray-500 text-sm">
            ...
            <span>{deliveryTime || 3} jours</span>
          </div>
